...
export function ServiceRequestModal({ property, isOpen, onClose, initialService }: ServiceRequestModalProps) {
 if (!isOpen) return null;

 return (
 <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-zinc-900/40 backdrop-blur-sm">
 <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl border border-zinc-200 flex flex-col relative custom-scrollbar">
 ...
 <div>
 <h2 className="text-xl font-extrabold text-zinc-900">Request Premium Services</h2>
 ...
 {/* Content */}
 <div className="p-6">
 <ServiceRequestForm property={property} onSuccess={() => {}} initialService={initialService} />
 </div>
 </div>
 </div>
 );
