...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Christchurch property for sale",
    "Takapuna real estate",
    "Remuera luxury homes",
    "Ponsonby villas for sale",
    "Mount Eden real estate",
    "waterfront property New Zealand",
    "off market property NZ",
    "apartments for sale Auckland CBD",
    "lifestyle blocks NZ",
    "commercial real estate New Zealand",
    "sell house New Zealand",
    "free property appraisal Auckland",
    "real estate agents Auckland",
    "top real estate agents NZ",
    "buy home NZ",
